        ...
        <div className="category-column">
          ...
          <div className="category-content">
            ...
            <div className="balance-sheet-total">
              <p>Cash Ending Balance:</p>
              <p>{((operatingTotal.totalDebit - operatingTotal.totalCredit) + (investingTotal.totalDebit - investingTotal.totalCredit) + (financingTotal.totalDebit - financingTotal.totalCredit)).toLocaleString()}</p>
            </div>
          </div>
        </div>
      </div>
